...
class TestApp(unittest.TestCase):
    ...
    def test_read_file_success(self, basePath=base_path):
        ...
        listJson = app.log_reader.LogFileReader.read_log_file(self, basePath + '/data/sampleValidData.json')
    ...
    def test_read_file_fail(self, basePath=base_path):
        ...
        fr = app.log_reader.LogFileReader.read_log_file(self, path)
    ...
    def test_extension_counter_success(self, basePath=base_path):
        ...
        listJson = app.log_reader.LogFileReader.read_log_file(self, basePath + '/data/sampleValidData.json')
        self.assertEqual(app.extension_counter.ExtensionCounter.get_extension_count(self, listJson), {'ext': 2, 'pdf': 1, 'exe': 1, 'pdf': 1, 'py': 1, 'ts': 1})
    ...
    def test_extension_counter_no_input_file_fail(self, basePath=base_path):
        ...
        path = basePath+'/data/sampleNegativeData.json'
        fr = app.log_reader.LogFileReader()
        self.assertRaises(TypeError, app.extension_counter.ExtensionCounter.get_extension_count, fr)
    ...
    def test_nm_key_fail(self, basePath=base_path):
        ...
        fr = app.log_reader.LogFileReader.read_log_file(self, path)
        self.assertRaises(KeyError, app.extension_counter.ExtensionCounter.get_extension_count, self, fr)
    ...
    def test_invalid_json_element(self, basePath=base_path):
        ...
        fr = app.log_reader.LogFileReader.read_log_file(self, path)
        self.assertRaises(json.decoder.JSONDecodeError, app.extension_counter.ExtensionCounter.get_extension_count, self, fr)
